        ...
        <div class="card">
            <div class="card-content">
                ...
                <form action="{{route('password.email')}}" method="POST" role="form">
                    ...
                    <button class="button is-primary is-outlined is-fullwidth m-t-30">Obtenir le lien</button>
                </form>
            </div>
        </div>
        <h5 class="has-text-centered m-t-20">
            <a href="{{route('login')}}" class=" has-text-grey-light">Retour à la connection </a>
        </h5>
    </div>
</div>
